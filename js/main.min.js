...
function applyScale(){slide.style.transform="scale(1)",slideBcr=slide.getBoundingClientRect(),slideWidth=slideBcr.width,slideHeight=slideBcr.height,slideRatio=slideHeight/slideWidth,slideScale=slideWrap.offsetWidth>slideWrap.offsetHeight/slideRatio?slideWrap.offsetHeight/slideRatio/slideWidth:slideWrap.offsetWidth*slideRatio/slideHeight,slideScale=Math.max(Math.min(slideScale,slideScaleMax),slideScaleMin)+.001,slide.style.transform="scale("+slideScale+")"}function setScale(){applyScale(),clearTimeout(slideScaleTimeout),slideScaleTimeout=setTimeout(applyScale,332)}function onResize(t){setScale()}function toggleZoom(){isZoom=!isZoom,document.documentElement.classList.toggle("zoom"),setScale()}function loadSlide(t){slideRequest||(location.hash=t+1,slideIndicator.innerHTML=t+1,isDev&&(document.title=slides[t]+" // Start Making Games"),game&&"function"==typeof game.kill&&game.kill(),game=null,document.documentElement.classList.add("loading"),slideRequest=new XMLHttpRequest,slideRequest.open("GET","slides/"+slides[t]+"/index.html",!0),slideRequest.onload=function(){slideRequest.status>=200&&slideRequest.status<400&&(clearTimeout(slideTimeout),slideTimeout=setTimeout(function(){if(null!==lastSlide){var e=document.querySelector(".stylesheet-"+lastSlide);e&&e.parentNode.removeChild(e);var i=document.querySelector(".script-"+lastSlide);i&&i.parentNode.removeChild(i)}var s=document.createElement("link");s.rel="stylesheet",s.href="slides/"+slides[t]+"/index.css",s.classList.add("stylesheet-"+t),document.getElementsByTagName("head")[0].appendChild(s),slideContent.innerHTML=slideRequest.responseText;var h=document.createElement("script");h.setAttribute("src","slides/"+slides[t]+"/index.js"),h.classList.add("script-"+t),document.getElementsByTagName("head")[0].appendChild(h),setTimeout(function(){document.documentElement.classList.remove("loading")},32),slideRequest=null,Prism.highlightAll()},32))},slideRequest.send())}function prevSlide(t){currentSlide>0&&!slideRequest&&(document.documentElement.classList.add("prev"),document.documentElement.classList.remove("next"),lastSlide=currentSlide,t?currentSlide-=5:currentSlide--,currentSlide=Math.max(0,currentSlide),loadSlide(currentSlide))}function nextSlide(t){totalSlides-1>currentSlide&&!slideRequest&&(document.documentElement.classList.add("next"),document.documentElement.classList.remove("prev"),lastSlide=currentSlide,t?currentSlide+=5:currentSlide++,currentSlide=Math.min(totalSlides-1,currentSlide),loadSlide(currentSlide))}var slides=["intro-t-title-1","intro-t-jack-1","intro-t-quotes-1","intro-t-poll-1","intro-t-poll-2","why-t-title-1","why-t-fun-1","why-t-recreational-1","why-t-ultimate-1","why-t-ways-1","why-t-past-1","why-t-your-own-1","why-t-watch-1","build-t-title-1","build-t-what-1","build-t-what-2","build-c-html-1","build-c-css-pong-1","build-d-css-pong-1","build-c-css-paddles-1","build-d-css-paddles-1","build-c-css-score-1","build-d-css-score-1","build-c-css-net-ball-1","build-d-css-net-ball-1","build-c-js-structure-1","build-c-js-config-1","build-c-js-object-paddle-player-1","build-c-js-object-paddle-enemy-1","build-c-js-object-ball-1","build-c-js-object-score-1","build-c-js-render-1","build-d-js-render-1","build-c-js-move-ball-1","build-c-js-update-1","build-c-js-loop-1","build-c-js-init-1","build-d-js-loop-1","build-c-js-contain-ball-1","build-c-js-update-2","build-d-js-contain-ball-1","build-c-js-move-player-1","build-c-js-update-3","build-c-js-add-event-listeners-1","build-c-js-init-2","build-d-js-move-player-1","build-c-js-move-enemy-1","build-i-js-random-1","build-c-js-update-4","build-d-js-move-enemy-1","build-c-js-contain-paddles-1","build-c-js-update-5","build-d-js-contain-paddles-1","build-c-js-collision-aabb-1","build-i-js-aabb-separation-conditions-1","build-c-js-check-collisions-1","build-c-js-update-6","build-d-js-check-collisions-1","build-c-js-contain-ball-2","build-d-js-contain-ball-2","build-c-js-reset-ball-1","build-c-js-contain-ball-3","build-d-js-reset-ball-1","build-c-js-check-win-state-1","build-c-js-update-7","build-c-js-reset-game-1","build-d-js-check-win-state-1","juice-t-title-1","juice-t-enhancements-1","juice-t-menu-1","juice-d-menu-1","juice-t-accel-1","juice-d-accel-1","juice-t-spin-1","juice-d-spin-1","juice-t-reaction-1","juice-d-reaction-1","juice-t-move3d-1","juice-d-move3d-1","juice-t-extrude-1","juice-d-extrude-1","juice-t-particles-1","juice-d-particles-1","juice-t-sound-1","juice-d-sound-1","juice-t-screenshake-1","juice-d-screenshake-1","juice-t-trajectory-1","juice-i-trajectory-1","juice-d-trajectory-1","juice-t-spike-1","juice-d-spike-1","juice-t-ghost-1","juice-d-ghost-1","juice-t-music-1","juice-d-music-1","outro-t-go-make-a-game-1","outro-t-thank-you-1"],game=null,slideWrap=document.querySelector(".slide-wrap"),slide=document.querySelector(".slide"),slideContent=document.querySelector(".slide-content"),slideBcr=slide.getBoundingClientRect(),slideWidth=slideBcr.width,slideHeight=slideBcr.height,slideRatio=slideHeight/slideWidth,slideScaleMin=0,slideScaleMax=1/0,slideScale,slideScaleTimeout;if(addEventListener("resize",onResize),setScale(),window.location.search.indexOf("dev")>-1){document.documentElement.classList.add("dev");var isDev=!0}if(window.location.search.indexOf("invert")>-1){document.documentElement.classList.add("invert");var isInverted=!0}var isZoom=!1;window.location.search.indexOf("zoom")>-1&&toggleZoom();var slideTimeout=null,lastSlide=null,totalSlides=slides.length,prevSlideButton=document.querySelector(".nav-prev"),nextSlideButton=document.querySelector(".nav-next"),slideIndicator=document.querySelector(".slide-indicator"),currentSlide,slideRequest;if(location.hash){var hash=parseInt(location.hash.slice(1),10);isNaN(hash)?currentSlide=0:(hash--,hash=Math.max(0,hash),hash=Math.min(totalSlides-1,hash),currentSlide=hash)}else currentSlide=0;currentSlide>totalSlides&&(currentSlide=0),prevSlideButton.addEventListener("click",function(t){t.preventDefault(),prevSlide(t.shiftKey)}),nextSlideButton.addEventListener("click",function(t){t.preventDefault(),nextSlide(t.shiftKey)}),slides.forEach(function(t,e){var i=new XMLHttpRequest;i.open("GET","slides/"+t+"/index.html",!0),i.send();var s=new XMLHttpRequest;s.open("GET","slides/"+t+"/index.css",!0),s.send();var h=new XMLHttpRequest;h.open("GET","slides/"+t+"/index.js",!0),h.send()});var controlDownDownEvent=new Event("controlDownDown"),controlDownUpEvent=new Event("controlDownUp"),controlUpDownEvent=new Event("controlUpDown"),controlUpUpEvent=new Event("controlUpUp"),controlSpikeDownEvent=new Event("controlSpikeDown"),controlSpikeUpEvent=new Event("controlSpikeUp"),mouseLeftDownEvent=new Event("mouseLeftDown"),mouseLeftUpEvent=new Event("mouseLeftUp"),mouseRightDownEvent=new Event("mouseRightDown"),mouseRightUpEvent=new Event("mouseRightUp"),controlMuteDownEvent=new Event("controlMuteDown"),controlPauseDownEvent=new Event("controlPauseDown"),keyMap={up:["up","w"],right:["right","d"],down:["down","s"],left:["left","a"],spike:["space","1"],prev:["left","openbracket","l2"],next:["right","closebraket","l1"],mute:["m","r2"],pause:["p","r1"],refresh:["4"],zoom:["z","2"]},keys={up:0,right:0,down:0,left:0},dirs={up:document.querySelector(".dir-up"),right:document.querySelector(".dir-right"),down:document.querySelector(".dir-down"),left:document.querySelector(".dir-left")},pg=playground({mousemove:function(t){document.documentElement.classList.remove("mouse-idle"),this.mouseIdle=!1,this.mouseIdleTick=this.mouseIdleTickMax},mousedown:function(t){"left"==t.button&&window.dispatchEvent(mouseLeftDownEvent),"right"==t.button&&window.dispatchEvent(mouseRightDownEvent)},mouseup:function(t){"left"==t.button&&window.dispatchEvent(mouseLeftUpEvent),"right"==t.button&&window.dispatchEvent(mouseRightUpEvent)},keydown:function(t){keyMap.up.indexOf(t.key)>-1?(keys.up=1,dirs.up.classList.add("is-active"),window.dispatchEvent(controlUpDownEvent)):keyMap.down.indexOf(t.key)>-1?(keys.down=1,dirs.down.classList.add("is-active"),window.dispatchEvent(controlDownDownEvent)):keyMap.spike.indexOf(t.key)>-1?window.dispatchEvent(controlSpikeDownEvent):keyMap.prev.indexOf(t.key)>-1?prevSlide(t.original.shiftKey):keyMap.next.indexOf(t.key)>-1?nextSlide(t.original.shiftKey):keyMap.mute.indexOf(t.key)>-1?window.dispatchEvent(controlMuteDownEvent):keyMap.pause.indexOf(t.key)>-1?window.dispatchEvent(controlPauseDownEvent):keyMap.zoom.indexOf(t.key)>-1&&toggleZoom()},keyup:function(t){keyMap.up.indexOf(t.key)>-1?(keys.up=0,dirs.up.classList.remove("is-active"),window.dispatchEvent(controlUpUpEvent)):keyMap.down.indexOf(t.key)>-1?(keys.down=0,dirs.down.classList.remove("is-active"),window.dispatchEvent(controlDownUpEvent)):keyMap.spike.indexOf(t.key)>-1&&window.dispatchEvent(controlSpikeUpEvent)},gamepaddown:function(t){keyMap.up.indexOf(t.button)>-1?(keys.up=1,dirs.up.classList.add("is-active"),window.dispatchEvent(controlUpDownEvent)):keyMap.right.indexOf(t.button)>-1?(keys.right=1,dirs.right.classList.add("is-active")):keyMap.down.indexOf(t.button)>-1?(keys.down=1,dirs.down.classList.add("is-active"),window.dispatchEvent(controlDownDownEvent)):keyMap.left.indexOf(t.button)>-1?(keys.left=1,dirs.left.classList.add("is-active")):keyMap.spike.indexOf(t.button)>-1?window.dispatchEvent(controlSpikeDownEvent):keyMap.prev.indexOf(t.button)>-1?(console.log(this.gamepads[0].buttons[3]),prevSlide(this.gamepads[0].buttons[3])):keyMap.next.indexOf(t.button)>-1?nextSlide(this.gamepads[0].buttons[3]):keyMap.mute.indexOf(t.button)>-1?window.dispatchEvent(controlMuteDownEvent):keyMap.pause.indexOf(t.button)>-1?window.dispatchEvent(controlPauseDownEvent):keyMap.refresh.indexOf(t.button)>-1?(this.refreshTick++,this.refreshTick>1&&location.reload(!0)):keyMap.zoom.indexOf(t.button)>-1&&toggleZoom()},gamepadup:function(t){keyMap.up.indexOf(t.button)>-1?(keys.up=0,dirs.up.classList.remove("is-active"),window.dispatchEvent(controlUpUpEvent)):keyMap.right.indexOf(t.button)>-1?(keys.right=0,dirs.right.classList.remove("is-active")):keyMap.down.indexOf(t.button)>-1?(keys.down=0,dirs.down.classList.remove("is-active"),window.dispatchEvent(controlDownUpEvent)):keyMap.left.indexOf(t.button)>-1?(keys.left=0,dirs.left.classList.remove("is-active")):keyMap.spike.indexOf(t.button)>-1&&window.dispatchEvent(controlSpikeUpEvent)},paths:{sounds:"snd/"},preferedAudioFormat:"mp3",create:function(){this.loadSounds(["paddle-1","wall-1","score-player-1","score-player-2","score-enemy-1","score-enemy-2","spike-1","spike-2","spike-3","slow-mo-1","hum-1","alarm-1","whoosh-1","music-1"])},ready:function(){this.dt=.016,this.dtMs=16,this.dtNorm=1,this.time=0,this.timeMs=0,this.timeNorm=0,this.mouseIdle=!1,this.mouseIdleTickMax=180,this.mouseIdleTick=this.mouseIdleTickMax,this.refreshTick=0,this.humLoop=this.playSound("hum-1",!0),this.sound.setVolume(this.humLoop,0),this.sound.setPlaybackRate(this.humLoop,1),this.alarmLoop=this.playSound("alarm-1",!0),this.sound.setVolume(this.alarmLoop,0),this.sound.setPlaybackRate(this.alarmLoop,1),loadSlide(currentSlide)},step:function(t){this.manageTime(t),this.mouseIdle||(this.mouseIdleTick>0?this.mouseIdleTick--:(this.mouseIdle=!0,document.documentElement.classList.add("mouse-idle")))},startMusic:function(){this.song=this.music.play("music-1",!0),this.music.setVolume(this.song,.3)},stopMusic:function(){this.music.fadeOut(this.song),this.song=null},manageTime:function(t){this.dt=t,this.dtMs=1e3*this.dt,this.dtNorm=60*this.dt,this.time+=this.dt,this.timeMs+=this.dtMs,this.timeNorm+=this.dtNorm},getDt:function(){return"undefined"==typeof this.dtNorm?1:this.dtNorm},soundPlay:function(t){var e="undefined"==typeof t.active?!1:t.active;if(e){var i="undefined"==typeof t.name?null:t.name,s="undefined"==typeof t.volume?1:t.volume,h="undefined"==typeof t.rate?1:t.rate,o="undefined"==typeof t.pan?0:t.pan;if(i){var n=pg.playSound(i);pg.sound.setVolume(n,s),pg.sound.setPlaybackRate(n,h),pg.sound.setPanning(n,o)}}}}),G=function(t){this.opt=t,this.config={paddle:{width:60,height:240,speed:16},enemy:{blindStart:.2,blindInc:.1,foresightStart:1.2,foresightInc:.2},ball:{width:60,height:60,speed:24,inc:1.25},score:{max:5}},this.raf=null,this.muted=!1,this.paused=!1,this.pausedTime=0,this.pausedStartTime=null,this.pausedEndTime=null,this.state="menu",this.done=!1,this.doneExitTick=0,this.doneExitTickMax=60,this.menu=document.querySelector(".g-menu"),this.menuExit=!1,this.menuExitTick=0,this.menuExitTickMax=20,this.result=document.querySelector(".g-result"),this.resultText=document.querySelector(".g-result-text"),this.resultPlayer=document.querySelector(".g-result-player"),this.resultEnemy=document.querySelector(".g-result-enemy"),this.resultMessage="",this.resultExitTick=0,this.resultExitTickMax=140,this.opt.music&&pg.startMusic(),this.screenshake=new this.Screenshake(this),this.timescale=new this.Timescale(this),this.stage=new this.Stage(this),this.opt.extrude&&this.addClass(this.stage.elem,"g-extrude"),this.opt.reaction&&this.addClass(this.stage.elem,"g-reaction"),this.paddlePlayer=new this.Paddle(this,!0),this.opt.spike||this.addClass(this.stage.elem,"g-no-spike"),this.paddleEnemy=new this.Paddle(this,!1),this.enemyBlind=this.config.enemy.blindStart,this.enemyForesight=this.config.enemy.foresightStart,this.paddleCollision=!1,this.ball=new this.Ball(this),this.scorePlayer=new this.Score(this,!0),this.scoreEnemy=new this.Score(this,!1),this.opt.reaction&&(this.overlay=document.querySelector(".g-overlay")),this.opt.reaction&&(this.edgeTop=document.querySelector(".g-edge-top"),this.edgeRight=document.querySelector(".g-edge-right"),this.edgeBot=document.querySelector(".g-edge-bot"),this.edgeLeft=document.querySelector(".g-edge-left")),this.opt.particles&&(this.particlesWhite=new this.Pool(this,this.ParticleWhite,30),this.particlesGreen=new this.Pool(this,this.ParticleGreen,30),this.particlesBlue=new this.Pool(this,this.ParticleBlue,30)),this.opt.particles&&(this.pulsesWhite=new this.Pool(this,this.PulseWhite,30),this.pulsesGreen=new this.Pool(this,this.PulseGreen,30),this.pulsesBlue=new this.Pool(this,this.PulseBlue,30)),this.init()};G.prototype.init=function(){this.addEventListeners(),this.loop()},G.prototype.showMenu=function(){this.removeClass(this.menu,"hidden")},G.prototype.hideMenu=function(){this.addClass(this.menu,"hidden")},G.prototype.showResult=function(){this.text(this.resultText,this.resultMessage),this.text(this.resultPlayer,this.scorePlayer.value),this.text(this.resultEnemy,this.scoreEnemy.value),this.removeClass(this.result,"hidden")},G.prototype.hideResult=function(){this.addClass(this.result,"hidden")},G.prototype.play=function(){this.menuExit=!0,this.hideMenu()},G.prototype.reset=function(){this.scorePlayer.setValue(0),this.scoreEnemy.setValue(0),this.enemyBlind=this.config.enemy.blindStart,this.enemyForesight=this.config.enemy.foresightStart,this.ball.speed=this.config.ball.speed,this.ball.reset(),this.done=!1},G.prototype.checkWinState=function(){this.done?(this.ball.opacity=0,pg.sound.setVolume(pg.humLoop,0),pg.sound.setVolume(pg.alarmLoop,0),this.paddlePlayer.currentCharge=0,this.paddlePlayer.isCharging=!1,this.paddlePlayer.isSpiking=!1,this.paddlePlayer.canSpike=!1,this.removeClass(this.paddlePlayer.elem,"hit"),this.doneExitTick<this.doneExitTickMax?this.doneExitTick++:(this.doneExitTick=0,this.showResult(),this.state="result")):this.scorePlayer.value>=this.config.score.max?(this.done=!0,this.resultMessage="You Won!"):this.scoreEnemy.value>=this.config.score.max&&(this.done=!0,this.resultMessage="You Lost")},G.prototype.step=function(){this.muted||pg.music.setMaster(this.timescale.current),this.opt.move3d&&this.stage.step(),this.paused||("play"===this.state&&(this.paddlePlayer.step(),this.paddleEnemy.step(),this.ball.step(),this.checkWinState(),this.paddleCollision=!1),this.timescale.step(),this.opt.screenshake&&this.screenshake.step(),this.opt.particles&&(this.particlesWhite.each("step"),this.particlesGreen.each("step"),this.particlesBlue.each("step"),this.pulsesWhite.each("step"),this.pulsesGreen.each("step"),this.pulsesBlue.each("step")),this.menuExit&&(this.menuExitTick<this.menuExitTickMax?this.menuExitTick++:(this.menuExit=!1,this.menuExitTick=0,this.state="play",this.reset())),"result"===this.state&&(this.resultExitTick<this.resultExitTickMax?this.resultExitTick++:(this.resultExitTick=0,this.state="menu",this.hideResult(),this.showMenu())))},G.prototype.draw=function(){this.stage.draw(),this.paddlePlayer.draw(),this.paddleEnemy.draw(),this.ball.draw(),this.scorePlayer.draw(),this.scoreEnemy.draw(),this.opt.particles&&(this.particlesWhite.each("draw"),this.particlesGreen.each("draw"),this.particlesBlue.each("draw"),this.pulsesWhite.each("draw"),this.pulsesGreen.each("draw"),this.pulsesBlue.each("draw"))},G.prototype.loop=function(){this.raf=requestAnimationFrame(this.loop.bind(this)),this.step(),this.draw()},G.prototype.kill=function(){cancelAnimationFrame(this.raf),this.opt.music&&pg.stopMusic(),this.config=null,this.stage=null,this.ball=null,this.paddlePlayer=null,this.paddleEnemy=null,this.scorePlayer=null,this.scoreEnemy=null,this.screenshake=null,this.timescale=null,this.overlay=null,this.edgeTop=null,this.edgeRight=null,this.edgeBot=null,this.edgeLeft=null,this.menu=null,this.result=null,this.resultText=null,this.resultPlayer=null,this.resultEnemy=null,this.opt.particles&&(this.particlesWhite.kill(),this.particlesWhite=null,this.particlesGreen.kill(),this.particlesGreen=null,this.particlesBlue.kill(),this.particlesBlue=null,this.pulsesWhite.kill(),this.pulsesWhite=null,this.pulsesGreen.kill(),this.pulsesGreen=null,this.pulsesBlue.kill(),this.pulsesBlue=null),this.unpause(),this.removeEventListeners()},G.prototype.Stage=function(t){this.g=t,this.elem=document.querySelector(".g-pong"),this.xDeg=0,this.xDegTarget=0,this.yDeg=0,this.yDegTarget=0,this.rangeDeg=10,this.xTrans=0,this.xTransTarget=0,this.yTrans=0,this.yTransTarget=0,this.smoothingDeg=.05,this.rotation=0,this.scaleBase=this.g.opt.move3d?.85:1,this.scale=this.scaleBase,this.width=1920,this.height=1080},G.prototype.Stage.prototype.step=function(){this.xDegTarget=this.g.done?0:2*(this.g.ball.y/(this.height-this.g.ball.height)-.5)*this.rangeDeg,this.xDeg+=(this.xDegTarget-this.xDeg)*this.smoothingDeg,this.yDegTarget=this.g.done?0:2*(this.g.ball.x/(this.width-this.g.ball.width)-.5)*this.rangeDeg,this.yDeg+=(this.yDegTarget-this.yDeg)*this.smoothingDeg,this.xTransTarget=this.g.done?0:.1*(-this.g.ball.x+this.width/2)*(10*(1-this.g.timescale.current)),this.xTrans+=(this.xTransTarget-this.xTrans)*this.smoothingDeg,this.yTransTarget=this.g.done?0:.1*(-this.g.ball.y+this.height/2)*(10*(1-this.g.timescale.current)),this.yTrans+=(this.yTransTarget-this.yTrans)*this.smoothingDeg,this.rotation=this.g.screenshake.angle,this.scale=this.scaleBase+.3*(1-this.g.timescale.current)},G.prototype.Stage.prototype.draw=function(){this.g.css(this.elem,"transform","scale( "+this.scale+" ) translateX("+(this.xTrans+this.g.screenshake.x)+"px) translateY("+(this.yTrans+this.g.screenshake.y)+"px) rotateX("+-this.xDeg+"deg) rotateY("+this.yDeg+"deg) rotateZ("+this.rotation+"rad)")},G.prototype.Ball=function(t){this.g=t,this.elem=document.querySelector(".g-ball-normal"),this.serving=!0,this.servingTimer=0,this.servingTimerMax=this.g.opt.sound?100:60,this.x=this.g.stage.width/2-this.g.config.ball.width/2,this.y=this.g.stage.height/2-this.g.config.ball.height/2,this.z=this.g.opt.extrude?60:2,this.speed=this.g.config.ball.speed,this.vx=0,this.vy=0,this.friction=.92,this.width=this.g.config.ball.width,this.height=this.g.config.ball.height,this.rotation=this.g.opt.spin?Math.PI/4:0,this.opacity=0,this.wasSpiked=!1,this.ghost={elem:document.querySelector(".g-ball-ghost"),x:this.x,y:this.y,z:60,vx:0,vy:0,rotation:this.g.opt.spin?Math.PI/4:0,active:!1}},G.prototype.Ball.prototype.reset=function(){this.serving=!0,this.ghost.active=!1,this.x=this.g.stage.width/2-this.width/2,this.y=this.g.stage.height/2-this.height/2+this.g.stage.height/3,this.opacity=0,this.vx=0,this.vy=0,this.g.paddlePlayer.hasHit=!1,this.g.paddleEnemy.hasHit=!1},G.prototype.Ball.prototype.contain=function(){if(this.y<=0||this.y+this.height>=this.g.stage.height){this.y<=0?(this.y=0,this.g.opt.reaction&&this.g.triggerClass(this.g.edgeTop,"hit")):(this.y=this.g.stage.height-this.height,this.g.opt.reaction&&this.g.triggerClass(this.g.edgeBot,"hit")),this.vy=-this.vy,pg.soundPlay({active:this.g.opt.sound,name:"wall-1",volume:.5,rate:this.g.rand(2.5,4)*(1-.4*(1-this.g.timescale.current))});var t=Math.atan2(this.vy,this.vx);if(this.g.screenshake.apply({translate:15,rotate:.15,xBias:0*Math.cos(t),yBias:-90*Math.sin(t)}),this.g.opt.particles){for(var e=0;15>e;e++){var i=this.g.rand(10,20);this.g.particlesWhite.create({width:i,height:i,x:this.x+this.g.rand(0,this.width)-i/2,y:this.y+this.g.rand(0,this.height)-i/2,z:this.g.rand(0,60),vx:this.g.rand(-3,3),vy:this.g.rand(-3,3),vz:this.g.rand(-2,2),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.05),friction:.99,shrink:!0,opacity:1})}i=60,this.g.pulsesWhite.create({width:i,height:i,x:this.x+this.width/2-i/2,y:this.y+this.height/2-i/2,z:1,r:Math.PI/4,shrink:!1,decay:.05,opacity:1})}}(this.ghost.y<=0||this.ghost.y+this.height>=this.g.stage.height)&&(this.ghost.y<=0?this.ghost.y=0:this.ghost.y=this.g.stage.height-this.height,this.ghost.vy=-this.ghost.vy);var s=!1;if(!this.g.paddleCollision&&this.x+this.width>this.g.stage.width&&(s=!0,this.g.scorePlayer.setValue(this.g.scorePlayer.value+1),this.g.opt.reaction&&(this.g.triggerClass(this.g.edgeRight,"hit"),this.g.triggerClass(this.g.scorePlayer.elem,"scored")),this.g.enemyBlind+=this.g.config.enemy.blindInc,this.g.enemyForesight+=this.g.config.enemy.foresightInc,pg.soundPlay({active:this.g.opt.sound,name:"score-player-2",volume:.9,rate:1})),this.ghost.active&&this.ghost.x+this.width>this.g.stage.width&&(this.ghost.vx=0,this.ghost.vy=0),!this.g.paddleCollision&&this.x<0&&(s=!0,this.g.scoreEnemy.setValue(this.g.scoreEnemy.value+1),this.g.opt.reaction&&(this.g.triggerClass(this.g.edgeLeft,"hit"),this.g.triggerClass(this.g.scoreEnemy.elem,"scored")),pg.soundPlay({active:this.g.opt.sound,name:"score-enemy-2",volume:.5,rate:1*(1-.4*(1-this.g.timescale.current))})),s){if(this.speed+=this.g.config.ball.inc,this.g.opt.reaction&&this.g.triggerClass(this.g.overlay,"flash"),this.wasSpiked=!1,this.g.screenshake.apply({translate:30,rotate:.3,xBias:0,yBias:0}),this.g.opt.particles){for(var e=0;15>e;e++){var i=this.g.rand(10,20);this.g.particlesWhite.create({width:i,height:i,x:this.x+this.g.rand(0,this.width)-i/2,y:this.y+this.g.rand(0,this.height)-i/2,z:this.g.rand(0,60),vx:this.g.rand(-3,3),vy:this.g.rand(-3,3),vz:this.g.rand(-2,2),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.05),friction:.99,shrink:!0,opacity:1})}i=60,this.g.pulsesWhite.create({width:i,height:i,x:this.x+this.width/2-i/2,y:this.y+this.height/2-i/2,z:1,r:Math.PI/4,shrink:!1,decay:.05,opacity:1})}this.reset()}},G.prototype.Ball.prototype.step=function(){if(this.contain(),this.serving&&!this.g.done){if(this.servingTimer<this.servingTimerMax){if(this.servingTimer++,this.servingTimer===(this.g.opt.sound?45:1)){if(this.g.opt.spin){this.opacity=0,this.y=this.g.stage.height/2-this.height/2+this.g.stage.height/3;pg.tween(this).to({y:this.g.stage.height/2-this.height/2,opacity:1},.65,"inOutExpo")}else this.y=this.g.stage.height/2-this.height/2,this.opacity=1;pg.soundPlay({active:this.g.opt.sound,name:"whoosh-1",volume:1.3,rate:1*(1-.4*(1-this.g.timescale.current))})}}else this.serving=!1,this.servingTimer=0,this.vx=this.speed,this.vy=this.speed,this.ghost.x=this.x,this.ghost.y=this.y,this.ghost.vx=this.speed*this.g.enemyForesight,this.ghost.vy=this.speed*this.g.enemyForesight,this.ghost.active=!0;this.g.opt.spin&&(this.rotation=Math.PI/4)}else if(this.g.opt.spin&&(this.vx>0?(this.rotation+=.005*Math.abs(this.vx)*this.g.timescale.getDt(),this.ghost.rotation+=.005*Math.abs(this.ghost.vx)*this.g.timescale.getDt()):(this.rotation-=.005*Math.abs(this.vx)*this.g.timescale.getDt(),this.ghost.rotation-=.005*Math.abs(this.ghost.vx)*this.g.timescale.getDt())),this.x+=this.vx*this.g.timescale.getDt(),this.y+=this.vy*this.g.timescale.getDt(),this.ghost.x+=this.ghost.vx*this.g.timescale.getDt(),this.ghost.y+=this.ghost.vy*this.g.timescale.getDt(),Math.sqrt(this.vx*this.vx+this.vy*this.vy)>this.speed&&(this.vx*=Math.pow(this.friction,this.g.timescale.getDt()),this.vy*=Math.pow(this.friction,this.g.timescale.getDt()),this.ghost.vx*=Math.pow(this.friction,this.g.timescale.getDt()),this.ghost.vy*=Math.pow(this.friction,this.g.timescale.getDt())),this.g.opt.particles&&!this.g.done){if(Math.random()<.5*this.g.timescale.getDt()){var t=60;this.wasSpiked?this.g.pulsesGreen.create({width:t,height:t,x:this.x+this.width/2-t/2,y:this.y+this.height/2-t/2,z:1+this.g.rand(0,60),r:this.rotation,shrink:!0,decay:.06,opacity:.25}):this.g.pulsesWhite.create({width:t,height:t,x:this.x+this.width/2-t/2,y:this.y+this.height/2-t/2,z:1+this.g.rand(0,60),r:this.rotation,shrink:!0,decay:.06,opacity:.25})}if(Math.random()<.6*this.g.timescale.getDt()){var t=this.g.rand(10,20);this.wasSpiked?this.g.particlesGreen.create({width:t,height:t,x:this.x+this.g.rand(0,this.width)-t/2,y:this.y+this.g.rand(0,this.height)-t/2,z:this.g.rand(0,60),vx:-this.vx/3,vy:-this.vy/3,vz:this.g.rand(-2,2),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.1),friction:.95,shrink:!0,opacity:1}):this.g.particlesWhite.create({width:t,height:t,x:this.x+this.g.rand(0,this.width)-t/2,y:this.y+this.g.rand(0,this.height)-t/2,z:this.g.rand(0,60),vx:-this.vx/3,vy:-this.vy/3,vz:this.g.rand(-2,2),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.1),friction:.95,shrink:!0,opacity:1})}}},G.prototype.Ball.prototype.draw=function(){this.g.css(this.elem,{opacity:this.opacity,transform:"translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) rotateZ("+this.rotation+"rad)"}),this.g.opt.ghost&&this.g.css(this.ghost.elem,{opacity:this.ghost.active?1:0,transform:"translate3d("+this.ghost.x+"px, "+this.ghost.y+"px, "+this.ghost.z+"px) rotateZ("+this.ghost.rotation+"rad)"})},G.prototype.Paddle=function(t,e){this.g=t,this.isPlayer=e,this.isEnemy=!e,this.y=this.g.stage.height/2-this.g.config.paddle.height/2,this.z=this.g.opt.extrude?60:1,this.vx=0,this.vy=0,this.vxMax=100,this.vyMax=25,this.ax=20,this.ay=2,this.friction=.85,this.width=this.g.config.paddle.width,this.height=this.g.config.paddle.height,this.speed=this.g.config.paddle.speed,this.angle=0,this.moveUp=!1,this.moveDown=!1,this.hasHit=!1,this.isSpiking=!1,this.canSpike=!0,this.isCharging=!1,this.currentCharge=0,this.spikeRange=200,this.spikeTarget=0,this.chargeRate=.0075,this.chargeDecay=.075,this.lastCharge=0,this.spikeHoldTick=0,this.spikeHoldTickMax=5,this.isPlayer?(this.elem=document.querySelector(".g-paddle-player"),this.x=0):(this.elem=document.querySelector(".g-paddle-enemy"),this.x=this.g.stage.width-this.g.config.paddle.width),this.chargeElem=document.querySelector(".g-charge"),this.xOrigin=this.x},G.prototype.Paddle.prototype.contain=function(){this.y<0&&(this.y=0,this.vy=0,this.moveUp=!1),this.y>this.g.stage.height-this.height&&(this.y=this.g.stage.height-this.height,this.vy=0,this.moveDown=!1)},G.prototype.Paddle.prototype.spike=function(){this.g.opt.spike&&this.canSpike&&(this.isSpiking=!0,this.spikeTarget=this.spikeRange*this.currentCharge,this.lastCharge=this.currentCharge,this.g.removeClass(this.elem,"hit"))},G.prototype.Paddle.prototype.checkCollisions=function(){var t;if(t=this.isPlayer?{x:this.x-1e3,y:this.y,width:this.width+1e3,height:this.height}:{x:this.x,y:this.y,width:this.width+1e3,height:this.height},this.g.collisionAABB(this.g.ball,t)){if(this.isPlayer&&this.g.ball.vx>0)return;if(this.isEnemy&&this.g.ball.vx<0)return;this.g.paddleCollision=!0;var e,i,s,h;if(this.isPlayer){if(e=-Math.PI/4,i=Math.sqrt(this.g.ball.vx*this.g.ball.vx+this.g.ball.vy*this.g.ball.vy),this.isSpiking?(pg.soundPlay({active:this.g.opt.sound,name:"spike-1",volume:.8*this.lastCharge,rate:this.g.rand(1,1.6)*(1-.4*(1-this.g.timescale.current))}),pg.soundPlay({active:this.g.opt.sound,name:"spike-2",volume:.8*this.lastCharge,rate:this.g.rand(1,1.6)*(1-.4*(1-this.g.timescale.current))}),pg.soundPlay({active:this.g.opt.sound,name:"spike-3",volume:.8*this.lastCharge,rate:this.g.rand(1,1.6)*(1-.4*(1-this.g.timescale.current))}),s=this.lastCharge>=1?25+175*this.lastCharge:25+125*this.lastCharge):s=0,h=i+s,this.isSpiking&&this.lastCharge>=1?(this.g.ball.wasSpiked=!0,this.g.timescale.triggerSlowMo(),this.g.opt.reaction&&this.g.triggerClass(this.g.overlay,"flash")):this.g.ball.wasSpiked=!1,e=.35*-Math.PI+(this.g.ball.y+this.g.ball.height-this.y)/(this.height+this.g.ball.height)*Math.PI*.7,this.g.ball.x=this.x+this.width,this.g.opt.trajectory?(this.g.ball.vx=Math.cos(e)*h,this.g.ball.vy=Math.sin(e)*h):this.g.ball.vx*=-1,this.g.opt.reaction&&(this.angle=e/2),this.g.opt.particles){for(var o=0;15>o;o++){var n=this.g.rand(10,20);this.g.particlesGreen.create({width:n,height:n,x:this.x+this.g.rand(0,this.width)-n/2,y:this.y+this.g.rand(0,this.height)-n/2,z:this.g.rand(60,120),vx:this.g.rand(-8,-4),vy:this.g.rand(-1,1),vz:this.g.rand(-4,4),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.05),friction:.95,shrink:!0,opacity:1})}n=60,this.g.pulsesGreen.create({width:n,height:n,x:this.g.ball.x+this.g.ball.width/2-n/2,y:this.g.ball.y+this.g.ball.height/2-n/2,z:1,r:Math.PI/4,shrink:!1,decay:.05,opacity:1})}}else if(this.g.ball.x=this.x-this.g.ball.width,e=-Math.PI/4,i=Math.sqrt(this.g.ball.vx*this.g.ball.vx+this.g.ball.vy*this.g.ball.vy),h=i,this.g.ball.wasSpiked=!1,e=.35*-Math.PI+(this.g.ball.y+this.g.ball.height-this.y)/(this.height+this.g.ball.height)*Math.PI*.7,this.g.ball.x=this.x-this.g.ball.width,this.g.opt.trajectory?(this.g.ball.vx=Math.cos(e)*-h,this.g.ball.vy=Math.sin(e)*h):this.g.ball.vx*=-1,this.g.opt.reaction&&(this.angle=-e/2),this.g.opt.particles){for(var o=0;15>o;o++){var n=this.g.rand(10,20);this.g.particlesBlue.create({width:n,height:n,x:this.x+this.g.rand(0,this.width)-n/2,y:this.y+this.g.rand(0,this.height)-n/2,z:this.g.rand(60,120),vx:this.g.rand(4,8),vy:this.g.rand(-1,1),vz:this.g.rand(-4,4),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.05),friction:.95,shrink:!0,opacity:1})}n=60,this.g.pulsesBlue.create({width:n,height:n,x:this.g.ball.x+this.g.ball.width/2-n/2,y:this.g.ball.y+this.g.ball.height/2-n/2,z:1,r:Math.PI/4,shrink:!1,decay:.05,opacity:1})}if(this.g.opt.particles)for(var o=0;15>o;o++){var n=this.g.rand(10,20);this.g.particlesWhite.create({width:n,height:n,x:this.g.ball.x+this.g.rand(0,this.g.ball.width)-n/2,y:this.g.ball.y+this.g.rand(0,this.g.ball.height)-n/2,z:this.g.rand(0,60),vx:this.g.rand(-3,3),vy:this.g.rand(-3,3),vz:this.g.rand(-2,2),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.05),friction:.99,shrink:!0,opacity:1})}this.g.opt.reaction&&this.g.triggerClass(this.elem,"hit"),this.hasHit=!0;var a=Math.atan2(this.g.ball.vy,this.g.ball.vx);this.isSpiking?this.lastCharge<1&&this.g.screenshake.apply({translate:15+100*this.lastCharge,rotate:.2,xBias:Math.cos(a)*(450+400*this.lastCharge),yBias:0*Math.sin(a)}):this.g.screenshake.apply({translate:15,rotate:.2,xBias:450*Math.cos(a),yBias:0*Math.sin(a)}),pg.soundPlay({active:this.g.opt.sound,name:"paddle-1",volume:.7,rate:this.g.rand(1.4,2)*(1-.4*(1-this.g.timescale.current))}),this.isPlayer?(this.g.ball.ghost.active=!0,this.g.ball.ghost.x=this.g.ball.x,this.g.ball.ghost.y=this.g.ball.y,this.g.ball.ghost.vx=Math.cos(e)*(h*this.g.enemyForesight),this.g.ball.ghost.vy=Math.sin(e)*(h*this.g.enemyForesight)):this.g.ball.ghost.active=!1}},G.prototype.Paddle.prototype.step=function(){if(this.isEnemy&&(!this.hasHit||Math.random()<this.g.enemyBlind)&&(this.moveUp=!1,
this.moveDown=!1,this.g.opt.trajectory&&this.g.ball.ghost.active?this.g.ball.ghost.y+this.g.ball.height<this.y+this.height/2?this.moveUp=!0:this.g.ball.ghost.y>this.y+this.height/2&&(this.moveDown=!0):this.g.ball.y+this.g.ball.height<this.y+this.height/2?this.moveUp=!0:this.g.ball.y>this.y+this.height/2&&(this.moveDown=!0)),this.g.opt.accel?this.moveUp?this.vy-=this.ay*this.g.timescale.getDt():this.moveDown?this.vy+=this.ay*this.g.timescale.getDt():this.vy*=this.friction:this.moveUp?this.y-=this.speed*this.g.timescale.getDt():this.moveDown&&(this.y+=this.speed*this.g.timescale.getDt()),this.angle+=.1*(0-this.angle),this.isSpiking?(this.canSpike=!1,this.vx+=this.ax):this.vx-=this.ax/20,this.vx<-this.vxMax&&(this.vx=-this.vxMax),this.vx>this.vxMax&&(this.vx=this.vxMax),this.vy<-this.vyMax&&(this.vy=-this.vyMax),this.vy>this.vyMax&&(this.vy=this.vyMax),this.x+=this.vx*this.g.timescale.getDt(),this.isCharging&&this.currentCharge>0&&this.currentCharge<=1?this.y+=this.vy/(1+4*this.currentCharge)*this.g.timescale.getDt():this.y+=this.vy*this.g.timescale.getDt(),this.g.opt.spike&&this.isCharging&&this.currentCharge<1&&this.canSpike&&(this.currentCharge+=this.chargeRate*this.g.timescale.getDt()),(!this.isCharging&&this.currentCharge>0||!this.canSpike)&&(this.currentCharge-=this.chargeDecay*this.g.timescale.getDt()),this.currentCharge=Math.max(0,this.currentCharge),this.currentCharge=Math.min(1,this.currentCharge),this.g.opt.particles&&this.currentCharge>0&&Math.random()<this.currentCharge/3){var t=this.g.rand(10,20);this.g.particlesGreen.create({width:t,height:t,x:this.x,y:this.y+this.g.rand(0,this.height)-t/2,z:this.g.rand(0,60),vx:this.g.rand(-20,-10),vy:this.g.rand(-2,2),vz:this.g.rand(-2,2),rx:this.g.rand(0,2*Math.PI),ry:this.g.rand(0,2*Math.PI),rz:this.g.rand(0,2*Math.PI),decay:this.g.rand(.01,.05),friction:.9,shrink:!0,opacity:1})}this.x>this.spikeTarget&&(this.x=this.spikeTarget,this.vx=0,this.spikeHoldTick<this.spikeHoldTickMax?this.spikeHoldTick++:(this.spikeHoldTick=0,this.isSpiking=!1)),this.x<this.xOrigin&&(this.x=this.xOrigin,this.vx=0,this.g.opt.spike&&!this.canSpike&&(this.canSpike=!0)),this.isPlayer&&this.g.opt.sound&&(pg.sound.setVolume(pg.humLoop,.2+.4*this.currentCharge),pg.sound.setPlaybackRate(pg.humLoop,5*this.currentCharge),pg.sound.setVolume(pg.alarmLoop,.2+.3*this.currentCharge),pg.sound.setPlaybackRate(pg.alarmLoop,3*this.currentCharge)),this.isPlayer&&this.currentCharge>=1&&this.g.addClass(this.elem,"hit"),this.contain(),this.checkCollisions()},G.prototype.Paddle.prototype.draw=function(){if(this.isCharging){var t=this.currentCharge<1?1:.75+.25*Math.cos(Date.now()/30);t=1,this.g.css(this.elem,{opacity:t,transform:"translate3d("+(this.x+this.g.rand(5*-this.currentCharge,5*this.currentCharge))+"px, "+(this.y+this.g.rand(5*-this.currentCharge,5*this.currentCharge))+"px, "+this.z+"px) rotateZ("+(this.angle+this.g.rand(.05*-this.currentCharge,.05*this.currentCharge))+"rad)"})}else this.g.css(this.elem,{opacity:1,transform:"translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) rotateZ("+this.angle+"rad)"});this.isPlayer&&this.g.css(this.chargeElem,{opacity:this.currentCharge<1?this.currentCharge:.75+.25*Math.sin(Date.now()/30),transform:"scaleX("+(.23+.77*this.currentCharge)+") translateZ( 2px )"})},G.prototype.Score=function(t,e){this.g=t,this.isPlayer=e,this.isEnemy=!e,this.value=0,this.flag=!0,this.isPlayer?this.elem=document.querySelector(".g-score-player"):this.elem=document.querySelector(".g-score-enemy"),this.elemText=this.elem.querySelector(".g-score-text")},G.prototype.Score.prototype.setValue=function(t){this.value=t,this.flag=!0},G.prototype.Score.prototype.draw=function(){this.flag&&(this.g.text(this.elemText,this.value),this.g.attr(this.elem,"data-score",this.value.toString()),this.flag=!1)},G.prototype.Screenshake=function(t){this.g=t,this.translate=0,this.rotate=0,this.x=0,this.y=0,this.xTarget=0,this.yTarget=0,this.xBias=0,this.yBias=0,this.angle=0,this.angleTarget=0},G.prototype.Screenshake.prototype.apply=function(t){this.translate=t.translate,this.rotate=t.rotate,this.xBias=t.xBias,this.yBias=t.yBias},G.prototype.Screenshake.prototype.step=function(){this.xBias*=.9,this.yBias*=.9,this.translate>0?(this.translate*=.9,this.xTarget=this.g.rand(-this.translate,this.translate)+this.xBias,this.yTarget=this.g.rand(-this.translate,this.translate)+this.yBias):(this.xTarget=0,this.yTarget=0),this.rotate>0?(this.rotate*=.9,this.angleTarget=this.g.rand(-this.rotate,this.rotate)):this.angleTarget=0,this.x+=.1*(this.xTarget-this.x),this.y+=.1*(this.yTarget-this.y),this.angle+=.1*(this.angleTarget-this.angle)},G.prototype.Timescale=function(t){this.g=t,this.current=1,this.target=.15,this.timer=0,this.timerMax=40,this.inDuration=.2,this.outDuration=.6,this.isSlow=!1},G.prototype.Timescale.prototype.step=function(){this.isSlow&&(this.timer<this.timerMax?this.timer+=this.getCoreDt():(this.timer=0,this.isSlow=!1,pg.tween(this).to({current:1},this.outDuration,"inQuad")))},G.prototype.Timescale.prototype.triggerSlowMo=function(){this.isSlow||(pg.soundPlay({active:this.g.opt.sound,name:"slow-mo-1",volume:1,rate:1}),this.isSlow=!0,pg.tween(this).to({current:this.target},this.inDuration,"outQuad"))},G.prototype.Timescale.prototype.getDt=function(){return pg.getDt()*this.current},G.prototype.Timescale.prototype.getInverseDt=function(){return 1-pg.getDt()*this.current},G.prototype.Timescale.prototype.getCoreDt=function(){return pg.getDt()},G.prototype.Timescale.prototype.getCoreInverseDt=function(){return 1-pg.getDt()},G.prototype.addEventListeners=function(){this.controlUpDownBound=this.onControlUpDown.bind(this),this.controlDownDownBound=this.onControlDownDown.bind(this),this.controlSpikeDownBound=this.onControlSpikeDown.bind(this),this.controlUpUpBound=this.onControlUpUp.bind(this),this.controlDownUpBound=this.onControlDownUp.bind(this),this.controlSpikeUpBound=this.onControlSpikeUp.bind(this),this.mouseLeftDownBound=this.onMouseLeftDown.bind(this),this.controlMuteDownBound=this.onControlMuteDown.bind(this),this.controlPauseDownBound=this.onControlPauseDown.bind(this),window.addEventListener("controlUpDown",this.controlUpDownBound),window.addEventListener("controlDownDown",this.controlDownDownBound),window.addEventListener("controlSpikeDown",this.controlSpikeDownBound),window.addEventListener("controlUpUp",this.controlUpUpBound),window.addEventListener("controlDownUp",this.controlDownUpBound),window.addEventListener("controlSpikeUp",this.controlSpikeUpBound),window.addEventListener("mouseLeftDown",this.mouseLeftDownBound),window.addEventListener("controlMuteDown",this.controlMuteDownBound),window.addEventListener("controlPauseDown",this.controlPauseDownBound)},G.prototype.removeEventListeners=function(){window.removeEventListener("controlUpDown",this.controlUpDownBound),window.removeEventListener("controlDownDown",this.controlDownDownBound),window.removeEventListener("controlSpikeDown",this.controlSpikeDownBound),window.removeEventListener("controlUpUp",this.controlUpUpBound),window.removeEventListener("controlDownUp",this.controlDownUpBound),window.removeEventListener("controlSpikeUp",this.controlSpikeUpBound),window.removeEventListener("mouseLeftDown",this.mouseLeftDownBound),window.removeEventListener("controlMuteDown",this.controlMuteDownBound),window.removeEventListener("controlPauseDown",this.controlPauseDownBound)},G.prototype.onControlUpDown=function(){this.paddlePlayer.moveUp=!0,"menu"===this.state&&this.play()},G.prototype.onControlDownDown=function(){this.paddlePlayer.moveDown=!0,"menu"===this.state&&this.play()},G.prototype.onControlSpikeDown=function(){this.paddlePlayer.isCharging=!0,"menu"===this.state&&this.play()},G.prototype.onControlUpUp=function(){this.paddlePlayer.moveUp=!1},G.prototype.onControlDownUp=function(){this.paddlePlayer.moveDown=!1},G.prototype.onControlSpikeUp=function(){this.paused||(this.paddlePlayer.isCharging=!1,this.paddlePlayer.spike())},G.prototype.onMouseLeftDown=function(){},G.prototype.onControlMuteDown=function(){this.muteToggle()},G.prototype.onControlPauseDown=function(){this.pauseToggle()},G.prototype.muteToggle=function(){this.muted?this.unmute():this.mute()},G.prototype.mute=function(){this.muted=!0,pg.sound.setMaster(0),pg.music.setMaster(0)},G.prototype.unmute=function(){this.muted=!1,pg.sound.setMaster(1),pg.music.setMaster(1)},G.prototype.pauseToggle=function(){this.paused?this.unpause():this.pause()},G.prototype.pause=function(){this.paused=!0,document.documentElement.classList.add("paused"),pg.sound.setVolume(pg.humLoop,0)},G.prototype.unpause=function(){this.paused=!1,document.documentElement.classList.remove("paused")},G.prototype.rand=function(t,e){return Math.random()*(e-t)+t},G.prototype.randInt=function(t,e){return Math.floor(t+Math.random()*(e-t+1))},G.prototype.collisionAABB=function(t,e){return t.x>e.x+e.width||t.x+t.width<e.x||t.y>e.y+e.height||t.y+t.height<e.y?void 0:!0},G.prototype.isString=function(t){return"string"==typeof t},G.prototype.isObject=function(t){return"object"==typeof t},G.prototype.isSet=function(t){return"undefined"!=typeof t},G.prototype.isObjEmpty=function(t){for(var e in t)if(t.hasOwnProperty(e))return!1;return!0},G.prototype.merge=function(t,e){for(var i in e)t[i]=e[i]},G.prototype.Pool=function(t,e,i){this.g=t,this.base=e,this.preallocateAmount=i||0,this.alive=[],this.dead=[],this.length=0,this.deadLength=0,this.preallocateAmount&&this.preallocate()},G.prototype.Pool.prototype.preallocate=function(){for(var t=0;t<this.preallocateAmount;t++)this.dead.push(new this.base(this.g,this)),this.deadLength++},G.prototype.Pool.prototype.create=function(t){if(this.deadLength){var e=this.dead.pop();return e.init(t),this.alive.push(e),this.deadLength--,this.length++,e}var i=new this.base(this.g,this);return i.init(t),this.alive.push(i),this.length++,i},G.prototype.Pool.prototype.release=function(t){var e=this.alive.indexOf(t);e>-1&&(this.dead.push(this.alive.splice(e,1)[0]),this.length--,this.deadLength++)},G.prototype.Pool.prototype.empty=function(){this.alive.length=0,this.dead.length=0,this.length=0,this.deadLength=0},G.prototype.Pool.prototype.each=function(t,e){for(var i=this.length;i--;)this.alive[i][t](i)},G.prototype.Pool.prototype.kill=function(){this.alive.length=0,this.alive=null,this.dead.lengh=0,this.dead=null},G.prototype.qS=function(t){var e=document.querySelectorAll(t);return e.length>1?e:e[0]},G.prototype.cE=function(t,e){var i=document.createElement("div");return t&&t.appendChild(i),e&&this.addClass(i,e),i},G.prototype.text=function(t,e){t.firstChild.nodeValue=e},G.prototype.triggerClass=function(t,e){this.addClass(t,e),t.offsetWidth=t.offsetWidth,this.removeClass(t,e)},G.prototype.prefixMatches={},G.prototype.prefixCheck=function(t){if(this.prefixElement||(this.prefixElement=this.cE()),this.prefixMatches[t])return[this.prefixMatches[t],!0];for(var e=["","Webkit","Moz","ms","O"],i=function(t){return t.toUpperCase()},s=0,h=e.length;h>s;s++){var o;if(o=0===s?t:e[s]+t.replace(/^\w/,i),this.isString(this.prefixElement.style[o]))return this.prefixMatches[t]=o,[o,!0]}return[t,!1]},G.prototype.css=function(t,e,i){if(this.isObject(e)){var s=e;for(e in s)s.hasOwnProperty(e)&&this.css(t,e,s[e])}else e=this.prefixCheck(e),e[1]&&(t.style[e[0]]=i)},G.prototype.hasClass=function(t,e){return e?t.classList.contains(e):void 0},G.prototype.addClass=function(t,e){e.length&&(-1!=e.indexOf(" ")?(classes=e.split(" "),classes.forEach(function(e){G.hasClass(t,e)||G.addClass(t,e)})):t.classList.add(e))},G.prototype.removeClass=function(t,e){-1!=e.indexOf(" ")?(classes=e.split(" "),classes.forEach(function(e){this.hasClass(t,e)&&this.removeClass(t,e)})):t.classList.remove(e)},G.prototype.attr=function(t,e,i){return i?(t.setAttribute(e,i),i):t.getAttribute(e)},G.prototype.Particle=function(t,e){this.g=t,this.parent=e,this.elem=this.g.cE(this.g.stage.elem,"g-particle"),this.g.css(this.elem,{opacity:0,transform:"translate3d(-999px , -999px, 0)"})},G.prototype.Particle.prototype.init=function(t){this.width=t.width,this.height=t.height,this.x=t.x,this.y=t.y,this.z=t.z,this.vx=t.vx,this.vy=t.vy,this.vz=t.vz,this.rx=t.rx,this.ry=t.ry,this.rz=t.rz,this.decay=t.decay,this.friction=t.friction,this.shrink=t.shrink,this.opacityBase=t.opacity,this.life=1,this.scale=1,this.opacity=this.opacityBase},G.prototype.Particle.prototype.step=function(){this.vx*=this.friction,this.vy*=this.friction,this.vz*=this.friction,this.x+=this.vx*this.g.timescale.getDt(),this.y+=this.vy*this.g.timescale.getDt(),this.z+=this.vz*this.g.timescale.getDt(),this.life-=this.decay*this.g.timescale.getDt(),this.shrink&&(this.scale=this.life),this.opacity=this.life*this.opacityBase,this.life<=0&&this.destroy()},G.prototype.Particle.prototype.draw=function(){this.g.css(this.elem,{opacity:this.opacity,transform:"translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) rotateX("+this.rx+"rad) rotateY("+this.ry+"rad) rotateZ("+this.rz+"rad) scaleX("+this.width*this.scale+") scaleY("+this.height*this.scale+")"})},G.prototype.Particle.prototype.destroy=function(){this.g.css(this.elem,{opacity:0,transform:"translate3d(-999px , -999px, 0)"}),this.parent.release(this)},G.prototype.ParticleWhite=function(t){this.g=t,G.prototype.Particle.apply(this,arguments),this.color="#fff",this.g.css(this.elem,"background",this.color)},G.prototype.ParticleWhite.prototype=G.prototype.Particle.prototype,G.prototype.ParticleWhite.prototype.constructor=G.prototype.ParticleWhite,G.prototype.ParticleGreen=function(t){this.g=t,G.prototype.Particle.apply(this,arguments),this.color="hsl(130, 100%, 60%)",this.g.css(this.elem,"background",this.color)},G.prototype.ParticleGreen.prototype=G.prototype.Particle.prototype,G.prototype.ParticleGreen.prototype.constructor=G.prototype.ParticleGreen,G.prototype.ParticleBlue=function(t){this.g=t,G.prototype.Particle.apply(this,arguments),this.color="hsl(200, 100%, 60%)",this.g.css(this.elem,"background",this.color)},G.prototype.ParticleBlue.prototype=G.prototype.Particle.prototype,G.prototype.ParticleBlue.prototype.constructor=G.prototype.ParticleBlue,G.prototype.Pulse=function(t,e){this.g=t,this.parent=e,this.elem=this.g.cE(this.g.stage.elem,"g-pulse"),this.g.css(this.elem,{opacity:0,transform:"translate3d(-999px , -999px, 0)"})},G.prototype.Pulse.prototype.init=function(t){this.width=t.width,this.height=t.height,this.x=t.x,this.y=t.y,this.z=t.z,this.r=t.r,this.shrink=t.shrink,this.decay=t.decay,this.opacityBase=t.opacity,this.life=1,this.scale=1,this.opacity=this.opacityBase},G.prototype.Pulse.prototype.step=function(){this.life-=this.decay*this.g.timescale.getDt(),this.shrink?this.scale=this.life:this.scale=0+(2-2*this.life),this.opacity=this.life*this.opacityBase,this.life<=0&&this.destroy()},G.prototype.Pulse.prototype.draw=function(){this.g.css(this.elem,{opacity:this.opacity,transform:"translate3d("+this.x+"px, "+this.y+"px, "+this.z+"px) rotateZ("+this.r+"rad) scaleX("+this.scale+") scaleY("+this.scale+")"})},G.prototype.Pulse.prototype.destroy=function(){this.g.css(this.elem,{opacity:0,transform:"translate3d(-999px , -999px, 0)"}),this.parent.release(this)},G.prototype.PulseWhite=function(t){this.g=t,G.prototype.Pulse.apply(this,arguments),this.color="#fff",this.g.css(this.elem,"border-color",this.color)},G.prototype.PulseWhite.prototype=G.prototype.Pulse.prototype,G.prototype.PulseWhite.prototype.constructor=G.prototype.PulseWhite,G.prototype.PulseGreen=function(t){this.g=t,G.prototype.Pulse.apply(this,arguments),this.color="hsl(130, 100%, 60%)",this.g.css(this.elem,"border-color",this.color)},G.prototype.PulseGreen.prototype=G.prototype.Pulse.prototype,G.prototype.PulseGreen.prototype.constructor=G.prototype.PulseGreen,G.prototype.PulseBlue=function(t){this.g=t,G.prototype.Pulse.apply(this,arguments),this.color="hsl(200, 100%, 60%)",this.g.css(this.elem,"border-color",this.color)},G.prototype.PulseBlue.prototype=G.prototype.Pulse.prototype,G.prototype.PulseBlue.prototype.constructor=G.prototype.PulseBlue;